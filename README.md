...
- **[Architecture Diagrams](architecture/diagrams.md)** - System architecture, workflows, and multi-brand data flow diagrams
- **[Database Design](patterns/data-model.md)** - Brand-first data model, schema design, and isolation patterns  
- **[API Architecture](patterns/api-design.md)** - Brand-aware REST API design with middleware and routing
- **[Authentication & Security](patterns/authentication.md)** - Cookie-based auth, role-based access, and brand scoping
- **[State Management](patterns/state-management.md)** - React Context patterns with TypeScript and brand theming
- **[File Storage](patterns/media-storage.md)** - MongoDB GridFS implementation with brand-isolated file handling
